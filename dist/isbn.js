...
},{"./lib/groups":6,"./lib/parse":7}],2:[function(require,module,exports){
'use strict';
...
},{"./calculate_check_digit":2,"./groups":6}],4:[function(require,module,exports){
'use strict';
...
var groupsMap = Object.keys(groups).reduce(function (obj, groupPrefix) {
...
module.exports = function (isbn13) {
  ...
  var possibleGroups = groupsMap[prefix][groupFirstDigit];
...
},{"./groups":6}],5:[function(require,module,exports){
'use strict';
...
},{"./fill":3,"./split_isbn_parts":8}],6:[function(require,module,exports){
'use strict';
...
module.exports = {
  ...
  '978-65': {
    name: 'Brazil',
    ranges: [['300', '302'], ['5000', '5104'], ['80000', '81699'], ['900000', '901999']]
  },
  '978-7': {
  ...
  '978-9920': {
    name: 'Morocco',
    ranges: [['35', '39'], ['625', '799'], ['9300', '9999']]
  },
  '978-9921': {
    name: 'Kuwait',
  ...
  '978-9976': {
    name: 'Tanzania',
    ranges: [['0', '4'], ['5000', '5899'], ['59', '89'], ['900', '989'], ['9900', '9999']]
  },
  '978-9977': {
    name: 'Costa Rica',
...
var getIsbnCodes = require('./get_isbn_codes');
...
},{"./get_isbn_codes":5}],8:[function(require,module,exports){
'use strict';
